...
const privacySections = [
  ...
  },
  {
    ...
    body: [
      "Mikoshi currently uses Google sign-in for account authentication. When you choose Google sign-in, your use of that sign-in flow is also subject to Google's own terms and privacy policy.",
        ...
        <div className="mb-6">
          <TerminalCard title="Overview" variant="brand">
            <div className="space-y-3 text-sm leading-7 text-muted-foreground">
              <p>
                Effective date:{" "}
                <span className="text-foreground">April 5, 2026</span>
              </p>
              <p>
              ...
              <div className="space-y-3 text-sm leading-7 text-muted-foreground">
                {section.body.map((paragraph) => (
                  <p key={paragraph}>
                    ...
                    "Mikoshi currently uses Google sign-in for account authentication. When you choose Google sign-in, your use of that sign-in flow is also subject to Google's own terms and privacy policy." ? (
                      <>
                        Mikoshi currently uses Google sign-in for account
                        authentication. When you choose Google sign-in, your use
                        of that sign-in flow is also subject to{" "}
                        <Link
